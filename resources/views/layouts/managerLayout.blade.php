...
<body class="sb-nav-fixed">
    ...
    <script>
        $(document).ready(function() {
            ...
            let unreadNotifications = @json(auth_manager()->notifications).filter(el => el.read_at == null);
            @json(auth_manager()->notifications).map(el => notifications_list.push(el.data.message));
            ...
            if (notifications_bell && notifications && notifications_count) {
                ...
                notifications_bell.addEventListener('click', (e) => {
                    ...
                    axios.post("{{ route('manager.notifications.read') }}").then(res => {
