        ...
        <div class="container-fluid px-4">
            ...
            <section class="mt-3 mb-3">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form method="GET" action="<?php echo e(route('manager.tasks')); ?>">
                            <div class="row">
                                <div class="col-md-8">
                                ...
                                <div class="col-md-3 d-flex justify-content-end align-items-end pb-3">
                                    <a class="btn btn-success" href="<?php echo e(route('manager.create-task')); ?>">Add New
                                        Task</a>
                                </div>
                            </div>
                            <div class="row">
                                    ...
                                    <?php $__currentLoopData = $tasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php else: ?>
                                                    <form action="<?php echo e(route('manager.edit-task', $task->id)); ?>"
                                                        method="GET">
                                            ...
                                            <td>
                                                <?php if($task->trashed()): ?>
                                                    <form
                                                        action="<?php echo e(route('manager.activate-task', $task->id)); ?>"
                                                        method="POST">
                                                        <?php echo csrf_field(); ?>
                                                ...
                                                <?php else: ?>
                                                    <form
                                                        action="<?php echo e(route('manager.deactivate-task', $task->id)); ?>"
                                                        method="POST">
                                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.managerLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vagrant/laravel/tms-laravel/resources/views/manager/tasks.blade.php ENDPATH**/ ?>