...
<body class="sb-nav-fixed">
            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link" href="<?php echo e(route('trainee.all-training-requests')); ?>">
                            <div class="sb-nav-link-icon"><i class="fas fa-graduation-cap text-success"></i></div>
                            My Training Requests
                        </a>
                        <a class="nav-link" href="<?php echo e(route('trainee.approved-training-programs')); ?>">
                            <div class="sb-nav-link-icon"><i class="fas fa-graduation-cap text-success"></i></div>
                            My Approved Training Programs
                        </a>
                        <a class="nav-link" href="<?php echo e(route('trainee.advisors-list')); ?>">
                        ...
                        <a class="nav-link" href="<?php echo e(route('trainee.sent-emails')); ?>">
                            <div class="sb-nav-link-icon"><i class="fas fa-users text-success"></i></div>
                            Sent Emails
                        </a>
                    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            let unreadNotifications = <?php echo json_encode(auth_trainee()->notifications, 15, 512) ?>.filter(el => el.read_at == null);
            ...
            if (notifications_bell && notifications && notifications_count) {
                ...
                notifications_bell.addEventListener('click', (e) => {
                    ...
                    axios.post("<?php echo e(route('trainee.notifications.read')); ?>").then(res => {
