...
<?php $__env->startSection('MainContent'); ?>
    <main>
        <div class="container-fluid px-4">
            ...
            <form class="mt-2 mb-4" action="<?php echo e(route('manager.create-task')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.managerLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vagrant/laravel/tms-laravel/resources/views/manager/create_task.blade.php ENDPATH**/ ?>