    ...
    <div class="col-lg-7">
        <div class="card shadow-lg border-0 rounded-lg mt-5">
            <div class="card-header">
                <h3 class="text-center font-weight-light my-4">Create Advisor Account</h3>
            </div>
            <div class="card-body">
                <div class="row">
                ...
                <form action="<?php echo e(route('advisor.register')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="row mb-2">
                        <div class="col-md-12">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <label for="disciplines">Select one or more disciplines that you want to advise
                        <strong class="text-danger">*</strong>
                    </label>
